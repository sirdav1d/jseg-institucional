				...
				<Flex
					...
					<Flex
						...
						<Heading
							...
							Caso precise de um orçamento com urgência, pode entrar em contato
							no botão abaixo
						</Heading>
						<ButtonGeneral
				...
				<Flex
					...
					<Flex
						...
						<Text fontSize={['sm', 'md', 'lg']}>
							Sabemos que o seu tempo é valioso, por isso preparamos uma
							surpresa para você. Baixe agora e descubra nosso brinde exclusivo!
						</Text>
						<Box
							w='400px'
							mb='100px'>
					...
					<Flex
						...
						<Center w='100%'>
							<Text
								...
								w={['100%', '100%', '100%', '70%']}>
								Telefone: 021-3628-4723 | E-mail:
								contato@jsegequipamentos.com.br |
								<br />
								JSEG Equipamentos - Dominus Tec Informática Eireli &copy; Todos
								os direitos reservados | CNPJ:08.644.747/0001-94 IE: 78.258.969
								| Av. Emani do Amaral Peixoto, 436, Stand 08 CEP: 24.020-077
								Centro - Niterói - RJ
							</Text>
						</Center>
					</Flex>
